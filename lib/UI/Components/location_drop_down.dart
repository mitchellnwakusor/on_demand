...
class ClientLocationDropDown extends StatefulWidget {
   const ClientLocationDropDown({super.key, required this.currentLocation});
   final String? currentLocation;

  @override
  State<ClientLocationDropDown> createState() => _ClientLocationDropDown();
}

class _ClientLocationDropDown extends State<ClientLocationDropDown> {
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField(
          ...
          onChanged: (value){
            selectedLocation = value;
            Provider.of<SignupProvider>(context,listen: false).addDataSignup(key: 'location', value: value);
          },
        ),
      ],
    );
